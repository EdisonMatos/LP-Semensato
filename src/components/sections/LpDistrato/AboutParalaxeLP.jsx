...
export default function AboutParalaxeLP() {
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${LpDistrato.about.bgImg})`,
          ...
          <SectionArea>
            <SectionWrapper>
              <div className="gap-y-[60px] flex flex-col items-center tablet2:flex-row tablet2:w-[100%] tablet2:justify-between tablet2:gap-[120px]">
                <img
                  src={LpDistrato.about.logo.logoImg}
                  alt={LpDistrato.about.logo.alt}
                  className="invert w-[90%] tablet2:w-[30%] desktop1:w-[40%]"
                />
                <div className="tablet2:w-[60%]">
                  <SectionHeader
                    className="text-center"
                    miniTitle={LpDistrato.about.sectionHeader.miniTag}
                    sectionHeaderTitle={LpDistrato.about.sectionHeader.title}
                    color=""
                    type="article"
                  />
                  <p className="font-mainFont mb-[36px]">
                    {LpDistrato.about.paragraph}
                  </p>
                  <div className="w-full">
                    <ButtonCustom
                      aria-label={LpDistrato.hero.textArea.ctaButtonAriaLabel}
                      label={LpDistrato.about.buttonLabel}
                      buttonLink={LpDistrato.links.ctaWhatsapp}
                      animation
                      className=""
                      icon={
                        <svg
