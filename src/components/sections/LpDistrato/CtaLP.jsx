...
export default function AboutParalaxeLP() {
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${LpDistrato.cta.bgImg})`,
          ...
          <SectionArea className="">
            <SectionWrapper>
              <SectionHeader
                ...
                miniTitle={LpDistrato.cta.sectionHeader.miniTag}
                sectionHeaderTitle={LpDistrato.cta.sectionHeader.title}
                sectionHeaderSubtitle={LpDistrato.cta.sectionHeader.subtitle}
                color=""
              />
              <ButtonCustom
                aria-label={LpDistrato.hero.textArea.ctaButtonAriaLabel}
                label={LpDistrato.cta.buttonLabel}
